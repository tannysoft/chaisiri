...
class arinstallermodel {
    ...
    var $view;
    var $form_popup;
    var $incomplete_entries;
    var $incomplete_entry_metas;
    ...
    function __construct() {
    	...
    	if ($blog_id and IS_WPMU) {
            ...
            $this->incomplete_entries = "{$prefix}arf_incomplete_formdata";
            $this->incomplete_entry_metas = "{$prefix}arf_incomplete_form_values";
            ...
            $this->incomplete_entries = $wpdb->prefix . "arf_incomplete_formdata";
            $this->incomplete_entry_metas = $wpdb->prefix . "arf_incomplete_form_values";
    	}
    ...
    function upgrade($old_db_version = false) {
        ...
        if ($arfdbversion != $old_db_version) {
            ...
            $sql = "CREATE TABLE IF NOT EXISTS {$this->forms} (
                ...
                arf_update_form tinyint(1) default 0,
                PRIMARY KEY  (id),
            ...
            $sql = "CREATE TABLE IF NOT EXISTS {$this->incomplete_entries}(
                id int(11) NOT NULL auto_increment,
                form_id int(11) NOT NULL,
            ...
            dbDelta( $sql );
            if( $wpdb->last_error != '' ){
                update_option('ARF_ERROR_'.time().rand(),"ERROR===>".htmlspecialchars( $wpdb->last_result, ENT_QUOTES )."QUERY===>".htmlspecialchars( $wpdb->last_query, ENT_QOUTES));
            }

            $sql = "CREATE TABLE IF NOT EXISTS {$this->incomplete_entry_metas}(
                id int(11) NOT NULL auto_increment,
                entry_id int(11) NOT NULL,
                field_id int(11) NOT NULL,
