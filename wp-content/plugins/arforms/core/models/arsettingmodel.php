...
class arsettingmodel {
	...
	function update($params, $cur_tab = '') {
		...
		if($cur_tab == 'general_settings') {
			...
			$this->hidden_captcha = isset($params['arfdisablehiddencaptcha']) ? $params['arfdisablehiddencaptcha'] : 0 ;
			$this->arfdisplayfilesinwpmedia = isset( $params['arfdisplayfilesinwpmedia'] ) ? $params['arfdisplayfilesinwpmedia'] : 0;
