...
if( $responder_list_id != '' )
{
	...
	$url = "https://api.madmimi.com/audience_lists/$responder_list_id/add?email=$email&first_name=$fname&last_name=$lname&username=$responder_api_email&api_key=$responder_api_key";
