...
<html <?php language_attributes(); ?>>
    <head>
        <script type="text/javascript" data-cfasync="false">
            ...
            var __ARF_SELECT_DEFAULT_LABEL = '<?php echo addslashes( esc_html__('Choose Option', 'ARForms') ); ?>';
            var __ARF_MULTI_SELECT_DEFAULT_LABEL = '<?php echo addslashes( esc_html__('Choose Options', 'ARForms') ); ?>';
        </script>
        ...
        $values = $arrecordhelper->setup_new_vars($fields, $form);
            ...
            if ( !empty( $form->form_css ) && ( $field['type'] == 'divider' || $field['type'] == 'section' )) {
            ...
            foreach ($custom_css_array as $custom_css_block => $custom_css_classes) {
                if (isset($field[$custom_css_block]) and $field[$custom_css_block] != '') {
                    ...
                    if ($custom_css_block == 'css_outer_wrapper' and $field['type'] != 'divider' and $field['type'] != 'section') {
                        echo ' .ar_main_div_' . $form->id . ' #arf_field_' . $field['id'] . '_' . $arf_data_uniq_id . '_container { ' . $field[$custom_css_block] . ' } ';
                    } else if ($custom_css_block == 'css_outer_wrapper' and $field['type'] == 'divider' and $field['type'] != 'section') {
                        echo ' .ar_main_div_' . $form->id . ' #heading_' . $field['id'] . ' { ' . $field[$custom_css_block] . ' } ';
                    } else if ($custom_css_block == 'css_label' and $field['type'] != 'divider' && $field['type'] != 'section') {
                    ...
                    } else if ($custom_css_block == 'css_description' and $field['type'] != 'divider' and $field['type'] != 'section') {
                    ...
                    } else if ($custom_css_block == 'css_add_icon' and $field['type'] != 'divider' and $field['type'] != 'section') {
        ...
        wp_print_styles('arf_animate_css_front');
        wp_print_scripts('arfpagebreaktimer');
        ...
        wp_print_styles('arf_trumbowyg-css');
        wp_print_scripts('arf_trumbowyg-js');
