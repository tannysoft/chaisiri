...
class arf_smiley_field {
    ...
    function __construct() {
        ...
        add_filter('arfaavailablefields', array( $this, 'arf_add_smiley_field_in_list'),10);
        ...
        add_filter('arf_new_field_array_materialize_outlined_filter_outside', array($this, 'arf_add_smiley_field_in_array_materialize'),10,4);
    ...
    function arf_add_smiley_field_in_list( $fields ){
        ...
        $fields['arf_smiley'] = array(
            ...
            'label' => addslashes(esc_html__('Smiley','ARForms'))
        );
                ...
                if (!empty($field['arf_smiley_images_array'])) {
                    ...
                    foreach ($as_arf_smiley_images as $key => $value) {
                        ...
                        <label id="smiley_<?php echo $field['id'] . '_' . $key; ?>" class="arf_smiley_btn arfhelptip" for="field_<?php echo $field['id'] . '_' . $key; ?>" title="<?php echo esc_attr($as_arf_smiley_title[$key]); ?>" <?php echo ($as_arf_smiley_type[$key] != "image")?'style="padding-top:4px;"':'';?>>
                            ...
                            <?php } else { ?>
                                <span class="arf_smiley_icon"><i class="fa-2x <?php echo $value; ?>"></i></span>
                            <?php } ?>
                        </label>
                    <?php } ?>
                <?php } ?>
            ...
            if (!empty($field['arf_smiley_images_array'])) {
                ...
                foreach ($as_arf_smiley_images as $key => $value) {
                    ...
                    if ($as_arf_smiley_type[$key] == 'image') {
                        ...
                        $return_string .='<span class="arf_smiley_icon"><i class="' . $value . ' fa-lg "></i></span>';
                    }
                    $return_string .='</label>';
                }
            }
    ...
    function arf_smiley_add_css_and_javascript($form) {
        ...
        if (isset($arf_smiley_loaded) && !empty($arf_smiley_loaded)) {
            ...
            <style type="text/css">
                ...
                .arf_form .arf_smiley_btn .arf_smiley_img{-webkit-box-shadow:none;}
                .arf_form .arf_smiley_btn .arf_smiley_icon{-webkit-box-shadow:none;}

                .arf_form .arf_smiley_btn .arf_smiley_img{-moz-box-shadow:none;}
                .arf_form .arf_smiley_btn .arf_smiley_icon{-moz-box-shadow:none;}

                .arf_form .arf_smiley_btn .arf_smiley_img{-o-box-shadow:none;}
                .arf_form .arf_smiley_btn .arf_smiley_icon{-o-box-shadow:none;}
    ...
    function arf_move_smiley_default_images_to_uploads() {
        ...
        foreach ($smiley_images as $source => $destination) {
            ...
            $arfilecontroller = new arfilecontroller( $source_path . '/' . $source, true );

            $arfilecontroller->check_only_image = true;

            $destination = $destination_path . '/' . $destination;

            $arfilecontroller->arf_process_upload( $destination );
