...
<input type="text" placeholder="<?php echo addslashes(esc_html__('Search','ARForms')); ?>" onkeyup="clearTimeout(__arf_fa_search_handle);__arf_fa_search_handle = (function($this) { setTimeout(function() { arf_fontawesome_search($this); }, 100); })(this);" id="arf_fontawesome_search" class="textbox arf_fontawesome_search"/>
