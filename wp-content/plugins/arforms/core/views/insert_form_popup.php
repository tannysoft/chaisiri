<?php
global $armainhelper, $arformhelper,$arfversion, $maincontroller;
?>
<script  type="text/javascript" data-cfasync="false">
    ...
    function arfopenarfinsertform() {
        ...
        jQuery('html').addClass('arf_hide_body_overflow');
    }
    ...
    function arfinsertform() {
        ...
        var arf_img_url = jQuery('#arf_img_url').val();
        var lin_type = jQuery('input[name="onclick_type"]:checked').val();
        if(lin_type == 'image'){
            if(arf_img_url == ""){
                alert("<?php echo addslashes(esc_html__('Please Select Image', 'ARForms')); ?>");
                return;
            }
        }
        ...
        var arf_img_url = jQuery('#arf_img_url').val();
        var arf_img_height = jQuery('#arf_img_height').val();
        var arf_img_width = jQuery('#arf_img_width').val();
        var arf_img_width = jQuery('#arf_img_width').val();
        var arf_img_height = jQuery('#arf_img_height').val();
        ...
        var hide_popup_for_loggedin_user = "no";
        if(jQuery('#arf_hide_popup_for_loggedin_user_input').is(":checked")) {
            hide_popup_for_loggedin_user = "yes";
        }
        ...
        if (shrt_type == 'normal')
        {
            ...
            var arfgt_shortcode='';
            if (link_type == 'sticky') {
               arfgt_shortcode=" [ARForms_popup id=" + form_id + " desc='" + caption + "' type='" + link_type + "' position='" + link_position + "' height='" + modal_height + "' width='" + modal_width + "' bgcolor='" + bgcolor + "' txtcolor='" + txtcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "' ]";
            } else if (link_type == 'fly'){
                var button_angle = jQuery('#button_angle').val();
                arfgt_shortcode=" [ARForms_popup id=" + form_id + " desc='" + caption + "' type='" + link_type + "' position='" + link_position_fly + "' height='" + modal_height + "' width='" + modal_width + "' angle='" + button_angle + "' bgcolor='" + bgcolor + "' txtcolor='" + txtcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "' ]";
            } else if (link_type == 'onload') {
                arfgt_shortcode=" [ARForms_popup id=" + form_id + " type='" + link_type + "' width='" + modal_width + "' modaleffect='"+modaleffect+"' is_fullscreen='"+show_full_screen+"' overlay='" + overlay + "' is_close_link='" + show_close_link + "' modal_bgcolor='" + modal_bgcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "' ]";

            } else if (link_type == 'scroll') {
                arfgt_shortcode=" [ARForms_popup id=" + form_id + " type='" + link_type + "' width='" + modal_width + "' modaleffect='"+modaleffect+"' is_fullscreen='"+show_full_screen+"' on_scroll='" + open_scroll + "' overlay='" + overlay + "' is_close_link='" + show_close_link + "' modal_bgcolor='" + modal_bgcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "' ]";

            } else if (link_type == 'button') {
                arfgt_shortcode=" [ARForms_popup id=" + form_id + " desc='" + caption + "' type='" + link_type + "' width='" + modal_width + "' modaleffect='"+modaleffect+"' is_fullscreen='"+show_full_screen+"' overlay='" + overlay + "' is_close_link='" + show_close_link + "' bgcolor='" + bgcolor + "' txtcolor='" + txtcolor + "' modal_bgcolor='" + modal_bgcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "' ]";

            } else if(link_type == 'image'){
                arfgt_shortcode=" [ARForms_popup id=" + form_id + " desc='" + caption + "' type='" + link_type + "' width='" + modal_width + "' modaleffect='"+modaleffect+"' is_fullscreen='"+show_full_screen+"' overlay='" + overlay + "' is_close_link='" + show_close_link + "' arf_img_url='" + arf_img_url + "' arf_img_height='" + arf_img_height + "' arf_img_width='" + arf_img_width + "' bgcolor='" + bgcolor + "' txtcolor='" + txtcolor + "' modal_bgcolor='" + modal_bgcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "']"; 
                               
            }else if (link_type == 'timer') {
                arfgt_shortcode=" [ARForms_popup id=" + form_id + " on_delay='" + open_delay + "' type='" + link_type + "' width='" + modal_width + "' modaleffect='"+modaleffect+"' is_fullscreen='"+show_full_screen+"' overlay='" + overlay + "' is_close_link='" + show_close_link + "' bgcolor='" + bgcolor + "' txtcolor='" + txtcolor + "' modal_bgcolor='" + modal_bgcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "' ]";

            }else if (link_type == 'on_exit') {
                
                arfgt_shortcode=" [ARForms_popup id=" + form_id + " type='" + link_type + "' width='" + modal_width + "' modaleffect='"+modaleffect+"' is_fullscreen='"+show_full_screen+"' is_close_link='" + show_close_link + "' modal_bgcolor='" + modal_bgcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "' ]";

            }else if(link_type == 'on_idle'){

                arfgt_shortcode=" [ARForms_popup id=" + form_id + " type='" + link_type + "' width='" + modal_width + "' modaleffect='"+modaleffect+"' is_fullscreen='"+show_full_screen+"' inactive_min='"+inact_min+"' overlay='" + overlay + "' is_close_link='" + show_close_link + "' bgcolor='" + bgcolor + "' txtcolor='" + txtcolor + "' modal_bgcolor='" + modal_bgcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "' ]";

            }else {
                arfgt_shortcode=" [ARForms_popup id=" + form_id + " desc='" + caption + "' type='" + link_type + "' width='" + modal_width + "' modaleffect='"+modaleffect+"'  is_fullscreen='"+show_full_screen+"' overlay='" + overlay + "' is_close_link='" + show_close_link + "' modal_bgcolor='" + modal_bgcolor + "' hide_popup_for_loggedin_user='" +hide_popup_for_loggedin_user+ "' ]";
            }
            if( typeof wp.blocks != 'undefined' ){
                if( typeof window.arf_props != 'undefined' && window.arf_props_selected == '1'){
                    window.arf_props.setAttributes( {'ARFShortcode': arfgt_shortcode});
    ...
    function disableScroll() {
        if (window.addEventListener){ /* older FF */
            window.addEventListener('wheel  DOMMouseScroll', arfpreventDefault, false);
        }
        document.onkeydown = preventDefaultForScrollKeys;
    }
    function enableScroll() {
        if (window.removeEventListener) {
            window.removeEventListener('wheel', arfpreventDefault, false);
            window.removeEventListener('DOMMouseScroll', arfpreventDefault, false);
        }
        document.onkeydown = null;
    }
    function arfpreventDefault(e) {
        e = e || window.event;
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(document).on('click', '.arf_selectbox', function (e) {
            if( typeof window.isLiteLoaded && true === window.isLiteLoaded ){
                return;
            }
            window.isProLoaded = true;
            $this = jQuery(this);
        ...
        jQuery(document).on('keydown', function(e) {
            ...
            if (jQuery('.arf-selectpicker-control dd ul:visible').length > 0) {
                arf_initialize_dropdown_keypress(e, e.keyCode, jQuery('.arf-selectpicker-control dd ul:visible'));
            }
        });
        ...
        jQuery('#link_type').change(function () {
            ...
            if (show_link_type == 'sticky' || radio_link_type == 'sticky') {
                ...
                jQuery('#arf_image_height_width').slideUp();
                jQuery('#arf_img_size').slideUp();
            ...
            } else if(show_link_type == 'image' || radio_link_type == 'image'){
                jQuery('#shortcode_caption').slideUp();
                jQuery('#arf_image_height_width').slideDown();
                jQuery('#arf_img_size').slideDown();
                jQuery('#is_fly').slideUp();
            ...
            if (show_link_type == 'onload' || show_link_type == 'scroll' || show_link_type == 'timer' ||  show_link_type == 'on_idle' ||  show_link_type == 'on_exit') {
                ...
                jQuery('#overlay_div').slideDown();
                jQuery('#modal_effect_div').slideDown();
            } else if(show_link_type == 'image'){
                jQuery('#shortcode_caption').slideUp();
            } else {
                jQuery('#shortcode_caption').slideDown();
            }

            if(show_link_type == 'onclick' || show_link_type == 'button' || show_link_type == 'image' || show_link_type == 'link' || show_link_type == 'sticky' || show_link_type == 'fly'){
...
wp_register_style('arf-selectpicker-css', ARFURL . '/css/arf_selectpicker.css', array(), $arfversion);
wp_register_script('arf-selectpicker-js', ARFURL . '/js/arf_selectpicker.js', array(), $arfversion);
$armainhelper->load_styles(array('arf-fontawesome-css'));
$armainhelper->load_styles(array('arf-selectpicker-css'));
$armainhelper->load_scripts(array('arf-selectpicker-js'));
...
<style type="text/css">
    ...
    body.rtl #show_link_type .arfdiv .arffirst_div,
    body.rtl #show_link_type .arfdiv .arffirst_div .arf_bg_color,
    body.rtl #show_link_type .arfdiv .arffirst_div .height_setting .arfheight{
        float: right;
    }
    body.rtl #show_link_type .arfdiv .arffirst_div .arf_coloroption_sub {
        margin-right: 30px;
        margin-left: unset;
        float: right !important;
    }
    body.rtl #show_link_type .arfdiv .arffirst_div .arf_coloroption_sub .arfbgcolornote{
        margin-left: -89px;
    }
   ...
   .arf_coloroption_sub .button.wp-color-result span{
    ...
    body.rtl .arf_coloroption_sub .wp-picker-container .wp-color-result.button{
        ...
        <div class='arfinsertform_modal_container arf_popup_content_container'>
            <div class="main_div_container">
                ...
                <?php 
                    ...
                    if (in_array($page, array('notenable'))) { ?>
                        <div class="">
                            <label for=""><?php echo esc_html__('Disable Multicolumn in Form','ARForms'); ?></label>
                            <?php
                            ...
                            ?>
                            <input type="hidden" class="arf_enable_multicolumn_hidden" name="test" id="test" value="1">
                            <div><input type="checkbox" id="arf_enable_multicolumn_checkbox"/> &nbsp;<label style="display: inline-block;" for="arf_enable_multicolumn_checkbox"><?php echo esc_html__('Yes','ARForms'); ?></label></div>
                        </div>
                <?php }
                 ?>                

                <div class="select_type arfmarginb20" style="float:left;width:100%;">
                ...
                <div id="show_link_type" style="display:none;">
                            ...
                            <div id="normal_link_type">     
                                ...
                                <div>
                                    ...
                                    <?php
                                        ...
                                        $arf_link_type_attr = array( 'onchange' => 'javascript:changetopposition(this.value);' );

                                        $arf_link_type_arr = array( 'onclick' => addslashes(esc_html__('On Click', 'ARForms')),
                                        ...
                                        echo $maincontroller->arf_selectpicker_dom( 'link_type', 'link_type', '', '', 'onclick', $arf_link_type_attr, $arf_link_type_arr );
                                    ?>                         
                                </div>          
                            </div>
                        </div>
                        ...
                        <div class="arffirst_div" style="width: 100%">
                            ...
                            <div class="radio_selection ">
                               ...
                               <div class="arf_radio_wrapper">
                                   <div class="arf_custom_radio_div">
                                       <div class="arf_custom_radio_wrapper">
                                           <input type="radio" class="arf_custom_radio" name="onclick_type" value="image" id="onclick_type_image" />
                                           <svg width="18px" height="18px">
                                           <?php echo ARF_CUSTOM_UNCHECKEDRADIO_ICON; ?>
                                           <?php echo ARF_CUSTOM_CHECKEDRADIO_ICON; ?>
                                           </svg>
                        ...
                        <div class="arffirst_div">
                            ...
                            <div class="dt_dl arf_bg_color" style="<?php
                                ...
                                <?php
                                    ...
                                    echo $maincontroller->arf_selectpicker_dom( 'overlay', 'overlay', '', 'width:85px;', '0.6', array(), $arf_overlay_opts );
                                ?>
                            </div>
                    ...
                    <!-- set image and size  -->
                      ...
                      <div class="arfdiv">
                          <div class="arffirst_div">
                                <div id="arf_image_height_width" style="display:none;">
                                    <label><?php echo addslashes(esc_html__('Image Url','ARForms')); ?></label>
                                    <input type="text" name="arf_img_url" id="arf_img_url" class="txtstandardnew" value="" style="width:270px;">
                                </div>
                            </div>

                            <div class="arfsecond_div" style="margin-left:50px; display: none;" id="arf_img_size">
                               
                            <label><?php echo addslashes(esc_html__('Image Size :', 'ARForms')); ?></label>
                            <div class="height_setting" style="float: left;">
                                <input type="text" onkeyup="if(jQuery(this).val() == 'auto') {jQuery('span#arf_img_height_px').hide();}else{ jQuery('span#arf_img_height_px').show();}" class="txtstandardnew" name="arf_img_height" id="arf_img_height" value="auto" style="width:70px;" />&nbsp;<span class="arf_px" id="arf_img_height_px" style="display: none;">px</span><br/>
                                <div class="arfheight"><?php echo addslashes(esc_html__('Height', 'ARForms')); ?></div>
                            </div>
                            <div class="height_setting" style="float: none;margin-left:95px;">
                                <input type="text" class="txtstandardnew" name="arf_img_width" id="arf_img_width" value="auto" style="width:70px;" />&nbsp;
                                <span class="arf_px">px</span><br/>
                                <div class="arfheight" style="width:122px;line-height:normal;"><?php echo addslashes(esc_html__('Width', 'ARForms')); ?>
                                </div>
                            </div>
                    ...
                    <div class="arfdiv">
                        <div class="arffirst_div">
                            ...
                            <div class="height_setting" style="display:none;float: left;">
                                <input type="text" onkeyup="if(jQuery(this).val() == 'auto') {jQuery('span#arf_modal_height_px').hide();}else{ jQuery('span#arf_modal_height_px').show();}" class="txtstandardnew" name="modal_height" id="modal_height" value="auto" style="width:70px;" />&nbsp;<span class="arf_px" id="arf_modal_height_px" style="display: none;">px</span><br/>
                                <div class="arfheight"><?php echo addslashes(esc_html__('Height', 'ARForms')); ?></div>
                            </div>
                        ...
                        <div class="arffirst_div" >
                          <div id="is_sticky" style="display:none;">
                               ...
                               <div class="dt_dl arf_bg_color" style="<?php
                                ...
                                <?php
                                    ...
                                    echo $maincontroller->arf_selectpicker_dom( 'link_position', 'link_position', '', 'width:235px;', 'top', array(), $arf_position_opts );
                                ?>
                            </div> 
                          </div>                        
                          <div id="is_fly" style="display:none;">
                               ...
                               <div class="dt_dl arf_bg_color" style="<?php
                                ...
                                <?php
                                    $arf_position_fly_attr = array( 'onchange' => 'arfchangeflybtn();' );
                                    $arf_position_fly_opts = array( 'left' => addslashes(esc_html__('Left', 'ARForms')),
                                                                    'right' => addslashes(esc_html__('Right', 'ARForms')),);

                                    echo $maincontroller->arf_selectpicker_dom( 'link_position_fly', 'link_position_fly', '', 'width:235px;', 'left', $arf_position_fly_attr, $arf_position_fly_opts );
                                ?>
                            ...
                            <div id="button_angle_div" style="display:none;">
                                ...
                                <div class="dt_dl arf_bg_color" style="<?php
                                    ...
                                    <?php
                                        ...
                                        echo $maincontroller->arf_selectpicker_dom( 'button_angle', 'button_angle', '', 'width:85px;', '0', $arf_angle_attr, $arf_angle_opts );
                                    ?>
                        ...
                        <div class="arfsecond_div" id="modal_effect_div">
                            ...
                            <div class="dt_dl" id="" style="<?php
                                ...
                                <?php                                    
                                    ...
                                    echo $maincontroller->arf_selectpicker_dom( 'modal_effect', 'modal_effect', '', 'width:135px;', 'fade_in', array(), $arf_modaleffect_opts );
                                ?>
                    ...
                    <div class="arfdiv">
                        <div class="arffirst_div" id="arf_hide_popup_loggedin_user">
                            <label><?php echo addslashes(esc_html__('Hide popup for Logged in User', 'ARForms')); ?></label> 
                            <div class="arf_custom_checkbox_wrapper">
                                <input type="checkbox" id="arf_hide_popup_for_loggedin_user_input" name="arf_hide_popup_for_loggedin_user_input" value="yes" style="border:none;">
                                <svg width="18px" height="18px">
