...
if ($form_id != '') {
    if ($atts['arf_forms_include_type'] == 'internal') {
        ...
        if ($atts['arf_show_close_button'] == 'false') {
            $arf_show_close_button = 'no';
        }

        $arf_show_full_screen = 'yes';
        if ($atts['arf_show_full_screen'] == 'false') {
            $arf_show_full_screen = 'no';
        }
        
        $arf_hide_popup_for_loggedin_user = "no";
        if(isset($atts['arf_hide_popup_for_loggedin_user_input']) && 'true'==$atts['arf_hide_popup_for_loggedin_user_input']) {
            $arf_hide_popup_for_loggedin_user = "yes";
        }
        ...
        $arforms_final_shortcode .= "[ARForms_popup id=" . $form_id . " desc='" . $atts['arf_link_caption'] . "' type='" . $atts['arf_link_type'] . "' height='" . $atts['arf_popup_height'] . "' width='" . $atts['arf_popup_width'] . "' overlay='" . $atts['arf_background_overlay'] . "' is_close_link='" . $arf_show_close_button . "' modal_bgcolor='" . $atts['arf_background_overlay_color'] . "' hide_popup_for_loggedin_user='" .$arf_hide_popup_for_loggedin_user. "' ";
        ...
        }else if($atts['arf_link_type'] == 'image'){
            $arforms_final_shortcode .= "arf_img_url='" . $atts['arf_img_url'] ."' arf_img_height='" . $atts['arf_img_height']."' arf_img_width='". $atts['arf_img_width']."' ";
        }
