...
$arf_cs_control['arf_onclick_type'] = array(
    ...
    'options' => array(
        'choices' => array(
            ...
            array('value' => 'image', 'label' => addslashes(esc_html__('image', 'ARForms'))),
...
$arf_cs_control['arf_img_url'] = array(
    'type' => 'text',
    'ui' => array(
        'title' => addslashes(esc_html__('Image Url', 'ARForms'))
    ),
    'condition' => array(
        'arf_forms_include_type' => 'external',
        'arf_onclick_type' => array('image')
    )
);

$arf_cs_control['arf_img_height'] = array(
    'type' => 'text',
    'ui' => array(
        'title' => addslashes(esc_html__('Image Height', 'ARForms'))
    ),
    'condition' => array(
        'arf_forms_include_type' => 'external',
        'arf_onclick_type' => array('image')
...
$arf_cs_control['arf_img_width'] = array(
    'type' => 'text',
    'ui' => array(
        'title' => addslashes(esc_html__('Image Width', 'ARForms'))
    ),
    'condition' => array(
        'arf_forms_include_type' => 'external',
        'arf_onclick_type' => array('image')
...
$arf_cs_control['arf_hide_popup_for_loggedin_user_input'] = array(
    'type' => 'toggle',
    'ui' => array(
        'title' => addslashes(esc_html__('Hide popup for Logged in User', 'ARForms'))
    ),
    'condition' => array(
        'arf_forms_include_type' => 'external',
    )
