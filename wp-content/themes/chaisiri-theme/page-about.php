...
$philosophy = get_field('philosophy', get_the_ID());
if($philosophy) {
...
<main id="primary" class="site-main">
  <div id="about_detail" class="pb-5">
    ...
    <div class="d-flex justify-content-center">
      <img class="banner" src="<?php echo $about_banner ?>" alt="about_banner">
    </div>
    <?php else : ?>
    <?php echo do_shortcode('[presto_player id=347]'); ?>
    <?php endif; ?>
    <!-- End Banner ------------------------------------>

    <div class="container pt-4 pt-md-5">
      <h1 data-aos-duration="1000" data-aos="fade-up" class="head">
        <?php echo (ICL_LANGUAGE_CODE == 'en') ? 'About Us' : 'เกี่ยวกับเรา'; ?>
        <div class="line">
          <div></div>
          <div></div>
        </div>
    ...
    <div class="row mt-3 mx-0 align-items-center bg-philosophy pt-3 pt-lg-0">
      ...
      <div class="col-lg-5 order-2 order-lg-1">
        <div data-aos-duration="1500" data-aos="fade-right" class="detail3 ml-auto">
          <h1>
            <?php echo $philosophy['philosophy_title_1']; ?>
          </h1>
          <div id="about_line2">
            <div></div>
            <div></div>
          </div>
          <p><?php echo $philosophy['philosophy_detail_1']; ?></p>
        </div>
      </div>
      <div class="col-lg-7 pr-lg-0 order-1 order-lg-2">
        <div class="about_detail_wrapper" data-aos-duration="1000" data-aos="fade-right">
          <img class="w-100 zoom_in" src="<?php echo $philosophy['philosophy_img_1']; ?>" alt="philosophy">
        </div>
      </div>
    </div>
    <!-- row 2 -->
    <div class="row mx-0 align-items-center bg-philosophy pt-3 pt-lg-0">
      <div class="col-lg-7 pl-lg-0">
        <div class="about_detail_wrapper" data-aos-duration="1000" data-aos="fade-right">
          <img class="w-100 zoom_in" src="<?php echo $philosophy['philosophy_img_2']; ?>" alt="philosophy">
        </div>
      </div>
      <div class="col-lg-5">
        <div data-aos-duration="1500" data-aos="fade-right" class="detail3 mr-auto">
          <h1><?php echo $philosophy['philosophy_title_2']; ?></h1>
          <div id="about_line2">
            <div></div>
            <div></div>
          </div>
          <p><?php echo $philosophy['philosophy_detail_2']; ?></p>
        </div>
      </div>
    </div>
    <!-- row 3 -->
    <div class="row mx-0 align-items-center bg-philosophy pt-3 pt-lg-0">
      <div class="col-lg-5 order-2 order-lg-1">
        <div data-aos-duration="1000" data-aos="fade-right" class="detail3 ml-auto">
          <h1><?php echo $philosophy['philosophy_title_3']; ?></h1>
          <div id="about_line2">
            <div></div>
            <div></div>
          </div>
          <p><?php echo $philosophy['philosophy_detail_3']; ?></p>
        </div>
      </div>
      <div class="col-lg-7 pr-lg-0 order-1 order-lg-2">
        <div class="about_detail_wrapper" data-aos-duration="1000" data-aos="fade-right">
          <img class="w-100 zoom_in" src="<?php echo $philosophy['philosophy_img_3']; ?>" alt="philosophy">
        </div>
      </div>
    </div>
    <!-- row 4 -->
    <div class="row mx-0 align-items-center bg-philosophy pt-3 pt-lg-0">
      <div class="col-lg-7 pl-lg-0">
        <div class="about_detail_wrapper" data-aos-duration="1000" data-aos="fade-right">
          <img class="w-100 zoom_in" src="<?php echo $philosophy['philosophy_img_4']; ?>" alt="philosophy">
        </div>
      </div>
      <div class="col-lg-5">
        <div data-aos-duration="1000" data-aos="fade-right" class="detail3 mr-auto">
          <h1><?php echo $philosophy['philosophy_title_4']; ?></h1>
          <div id="about_line2">
            <div></div>
            <div></div>
          </div>
          <p><?php echo $philosophy['philosophy_detail_4']; ?></p>
        </div>
      </div>
    </div>
    <!-- last detail -->
    <div class="container text-center">
      <div data-aos-duration="1000" data-aos="fade-up" class="detail4 mt-4 mt-md-5">
        <?php echo get_field('about_detail_3'); ?>
      </div>
      <div data-aos-duration="1000" data-aos="fade-up" class="box detail4 mt-4">
        <?php echo get_field('about_detail_4'); ?>
      </div>
    </div>
  </div>
</main><!-- #main -->
