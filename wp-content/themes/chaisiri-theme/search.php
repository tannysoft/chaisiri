...
<main id="primary" class="site-main">
	<?php if (have_posts()) :
		$banner = get_field('banner_head');
		var_dump($banner);
	?>
		<div id="work">
			<div class="banner-fade position-relative">
				<div class="about_detail_wrapper">
					<img class="banner-zoom" src="<?= $srcdir ?>/images/work/work-banner.jpeg" alt="work-banner" />
				</div>
				...
				<div class="container py-4 py-md-5">
					<div class="row">
						<div class="col-md-7 order-2 order-md-1">
							<img class="w-100" src="<?= $srcdir ?>/images/work/position.jpeg" alt="position" />
						</div>
